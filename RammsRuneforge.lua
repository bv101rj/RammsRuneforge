...
if not isDK and not isRogue then return end
...
SlashCmdList["RAMMSRUNEFORGE"] = function(msg)
    ...
    if msg == "debug" then
        ...
        elseif isRogue then
            ...
            print("  Lethal poisons active:", CountActivePoisons(LETHAL_POISONS),
                  "/ needed:", hasDTB and 2 or 1)
            print("  Non-lethal poisons active:", CountActivePoisons(NONLETHAL_POISONS),
                  "/ needed:", hasDTB and 2 or 1)
        end
        return
    end
...
C_Timer.After(3, function()
    if isDK then
        print("|cff66ccffRamm's Runeforge|r loaded — select the frame in Edit Mode to configure, or type |cffffffff/rrf|r.")
    else
